workspace "Prettier 3.8.x" "C4 Model for Prettier Project" {
    model {
        ...
        enterprise = group "Prettier Code Formatter" {
            // Context
            prettier = softwareSystem "Prettier (v3.8.x)" "Code formatter tool that parsesworkspace "Prettier 3.8.x" "C4 Model for Prettier Project" {
    model {
        developer = person "Developer" "Writes source code and defines styling criteria." "User"
        ...
        parserLayer -> pluginLayer "Takes custom parsers and printers" "In-memory Object Reference (Sync)" "Solid"
        ...
        configLayer -> parserLayer "Injects configuration" "OS File System API (Sync)" "Solid"
    }
